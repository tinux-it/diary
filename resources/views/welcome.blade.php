                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <div class="flex items-center justify-between mb-3">
                                                        <div class="flex items-center space-x-3">
                                                            ...
                                                            <div>
                                                                <h4 class="font-semibold text-gray-900 text-xl line-clamp-2">
                                                                    {{ $blogPost->subject }}
                                                                </h4>
                                                    ...
                                                    <div class="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-lg p-4 transition-all duration-200">
                                                        <div class="text-gray-700 text-sm line-clamp-4 mb-4">
                                                            {{ Str::limit(strip_tags($blogPost->content), 300) }}
                                                        </div>

                                                        <a href="{{ route('blog.show.public', $blogPost) }}"
                                                           class="inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-medium py-2 px-6 rounded-lg shadow-sm hover:shadow-md transform hover:scale-[1.02] transition-all duration-200 text-sm">
                                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
